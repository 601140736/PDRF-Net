...
class DehazeNet(nn.Module):
    def __init__(self, in_channel):
        ...
        # 卷积层：用于提取特征
        self.conv1 = nn.Conv2d(in_channel, 4, kernel_size=3, padding=1)
        self.conv2 = nn.Conv2d(4, 8, kernel_size=3, padding=1)
        self.conv5 = nn.Conv2d(8, 1, kernel_size=3, padding=1)  # 输出1个通道，用于透射率图
...
# ---- 去雾过程：通过大气散射模型公式去雾 ----
def dehaze_feature(hazy_image, transmission, A, t0=0.01):
