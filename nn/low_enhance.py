...
class Low_enhance_net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 4, kernel_size=3, padding=1, stride=1)
        self.conv2 = nn.Conv2d(4, 8, kernel_size=3, padding=1, stride=1)
        self.conv3 = nn.Conv2d(8, 12, kernel_size=3, padding=1, stride=1)
        self.conv4 = nn.Conv2d(12, 8, kernel_size=3, padding=1, stride=1)
